...
class VendingMachine {
    ...
    getItem(itemCode: string): ProductInterface|null {
    ...
    purchase(itemCode: string): ProductInterface|ErrorInterface {
    ...
    dispense(itemCode: string): ProductInterface {
        let item = this.getItem(itemCode);
    ...
    addChange(coins: ChangeInterface): ChangeInterface {
    ...
    calculateChange(amount: number): ChangeInterface {
        let coins = {
            quarters: 0,
            dimes: 0,
            nickels: 0,
    ...
    isChangeAvailable(change: ChangeInterface): boolean {
